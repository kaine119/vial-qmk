...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    // One default layout for QWERTY
    [0] = LAYOUT(
        KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,    KC_F10,  KC_F11,   KC_F12,   KC_PSCR,  KC_DEL,  KC_MUTE,
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,     KC_0,    KC_MINUS, KC_EQUAL, KC_BSPC,  KC_HOME,       
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,     KC_P,    KC_LBRC,  KC_RBRC,  KC_BSLS,  KC_PGUP,       
        KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,     KC_SCLN, KC_QUOTE,           KC_ENTER, KC_PGDN,       
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_B,    KC_N,    KC_M,    KC_COMMA, KC_DOT,  KC_SLASH, KC_RSFT,  KC_UP,    KC_END,       
        KC_LCTL, KC_LWIN, KC_LALT,          KC_SPC,                    KC_SPC,  KC_RALT,           MO(1),   KC_APP,   KC_LEFT,  KC_DOWN,  KC_RIGHT        
    ),
    // The rest can be figured out in Vial
    // Macro keys on the right are set to record / play dynamic macros by default
    [1] = LAYOUT(
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    // One default encoder mapping for volume
